...
```{r}
dat <- rio::import("http://offenedaten.frankfurt.de/dataset/48a91262-1d86-42ce-bab0-070313ab32f6/resource/5d7ec8ca-76a7-4546-9027-8e69b623e05a/download/tourismus.xls")
```

```{r}
anteil_international9 <- dat$`Tourismus Anteil der Gäste aus dem Ausland 2009`
